from Seminar917.Seminar11.domain.client import Client
from Seminar917.Seminar11.service.undo_service import FunctionCall, Operation, CascadedOperation
...
class ClientService:
    ...
    def delete(self, client_id):
        ...
        for rent in rentals:
            ...
            functionUndo = FunctionCall(rentalsRepo.store, rent)
