from Seminar917.Seminar11.domain.rental import Rental
from Seminar917.Seminar11.service.car_rental_exception import CarRentalException
from Seminar917.Seminar11.service.undo_service import FunctionCall, Operation
...
class RentalService:
    ...
    def create_rental(self, rental_id, client, car, start, end):
        ...
        functionRedo = FunctionCall(self._repository.store, rental)
        functionUndo = FunctionCall(self._repository.delete, rental_id)
